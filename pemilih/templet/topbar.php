  ...
  <li class="nav-item active">
    ...
    <!-- Heading -->
      <!--   <div class="sidebar-heading">
        ...
        <!-- Nav Item - voting -->
        <li class="nav-item">
          <a class="nav-link" href="voting.php?title=Halaman Voting">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ganti_password.php?title=Halaman Ganti Password">
            ...
            <li class="nav-item">
              <a class="nav-link" href="lihat_status.php?title=Halaman Lihat Status">
      ...
      <a class="dropdown-item" href="seting_profil.php?title=Seting Profil">
        <i class="fas fa-user"></i>
        Profile
      </a>
