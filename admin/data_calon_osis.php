          ...
          <tbody>
            ...
            while ($data = mysqli_fetch_array($query)) {
             ...
             <tr>
               ...
               <td>
                <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau hapus ?')" href="aksi_hapus.php?id=<?php echo $data['id_kandidat'] ?>&hapus=data_calon_osis&foto=<?php echo $data['foto'] ?>"><i class="fa fa-trash"></i></a>
                <button data-id="<?php echo $data['id_kandidat'] ?>" id="tombol-editkandidat" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
    ...
    <div class="modal-dialog" role="document">
     ...
     <div class="modal-body">
       <form action="aksi_insert.php?tambah=data_kandidat" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" name="tambah_kandidat" id="tombol-tambah-kandidat">Tambahkan</button>
