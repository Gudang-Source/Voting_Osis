...
if(isset($_GET['tambah'])){
	...
	if($get == 'data_pemilih'){
		...
		if(isset($_POST['tambah_pemilih'])){
			...
			if(!empty($cek_nis)){
				echo "<script>alert('NIS Sudah Di pakai..!'); document.location.href='data_pemilih.php'</script>";
				die();
			}
			...
			if($insert){
				echo "<script>alert('Data Berhasil di masukan..!'); document.location.href='data_pemilih.php'</script>";
			}else{
				echo mysqli_error($koneksi);
			}
		}else{
			echo "<script>alert('Data Gagal di masukan..!'); document.location.href='data_pemilih.php'</script>";
		}
		...
		if(isset($_POST['tambah_kandidat'])){
			...
			if($insert){
				echo "<script>alert('Data Berhasil di masukan..!'); document.location.href='data_calon_osis.php'</script>";
			}else{
				echo "<script>alert('Data Gagal di masukan..!'); document.location.href='data_calon_osis.php'</script>";
			}
		...
		if(isset($_POST['tambah_panitia'])){
			...
			if($insert){
				echo "<script>alert('Data Berhasil di masukan..!'); document.location.href='data_panitia.php'</script>";
			}else{
				echo "<script>alert('Data Gagal di masukan..!'); document.location.href='data_panitia.php'</script>";
			}
		}else{
			echo "<script>alert('Data Gagal di masukan..!'); document.location.href='data_panitia.php'</script>";
		}
		...
		if(isset($_POST['tambah_siswa'])){
			...
			if($insert){
				echo "<script>alert('Data Berhasil di masukan..!'); document.location.href='data_siswa.php'</script>";
			}else{
				echo "<script>alert('Data Gagal di masukan..!'); document.location.href='data_siswa.php'</script>";
			}
		}else{
			echo "<script>alert('Data Gagal di masukan..!'); document.location.href='data_siswa.php'</script>";
		}
