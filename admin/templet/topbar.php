  ...
  <!-- Sidebar -->
      ...
      <!--   <div class="sidebar-heading">
       ...
       <div id="master" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
         ...
         <a class="collapse-item" href="data_pemilih.php?title=halaman data pemilih">Data Pemilih</a>
         <a class="collapse-item" href="data_siswa.php?title=halaman data Siswa">Data Siswa</a>
         <a class="collapse-item" href="data_calon_osis.php?title=halaman data calon osis">Data Calon Osis</a>
         <a class="collapse-item" href="data_panitia.php?title=halaman data panitia">Data Panitia</a>
         <a class="collapse-item" href="data_admin.php?title=halaman data admin">Data Admin</a>
       </div>
     </div>
   </li>
   ...
   <!-- Nav Item - Dashboard -->
   <li class="nav-item">
    <a class="nav-link" href="check_voting.php?title=Halaman Check Voting">
      <i class="fas fa-fw fa-tachometer-alt"></i>
