  ...
  <div class="container-fluid">
    <div class="card">
     <div class="card-header">
      <h3 style="float:left">Data admin</h3>
      <a style="float: right" type="button" class="btn btn-outline-warning mb-4" data-toggle="modal" data-target="#modal-tambah-admin" ><i class="fas fa-user-plus"></i>Tambah admin</a>
    </div>
    <div class="card-body">
        ...
        <table class="table table-hover table-bordered table-striped" id="datatable" style="width:100%">
          <thead>
            <tr>
              ...
              <th class="text-center">Jenis Kelmain</th>
          ...
          <tbody>
            ...
            include '../koneksi.php';
            $no = 1;
            $query = mysqli_query($koneksi, "SELECT * FROM tb_user WHERE role='admin'");
            while ($data = mysqli_fetch_array($query)) {
             ...
             <tr>
               ...
               <td>
                <a class="btn btn-danger" onclick="return confirm('Yakin mau hapus ?')" href="aksi_hapus.php?id=<?php echo $data['id'] ?>&hapus=data_admin"><i class="fa fa-trash"></i></a>
                <button data-id="<?php echo $data['id'] ?>" id="tombol-editadmin" class="btn btn-info"><i class="fa fa-edit"></i></button>
              </td>
            </tr>
          <?php } ?>
        </tbody>
...
<script>
  $(document).ready(function(){
    $('#datatable').on('click','#tombol-editadmin', function(){
      ...
      $.ajax({
        url : 'mendapat_data_edit.php?dapat=data_admin',
        data : {'id': id},
        type : 'post',
        dataType : 'json',
        success: function(hasil){
          ...
          $('.penampung-edit-admin').html(`
            <form action="aksi_edit.php?edit=data_admin" method="post">
            ...
            <div class="alert alert-info btn-sm">Jika Tidak Mau Mengganti password Tidak Usah Di isi Form Password Di Bawah</div>
            <div class="form-group">
            ...
            <button style="width:140px" type="submit" class="btn btn-primary" name="edit_admin">Edit</button>
...
<!-- Modal tambah-->
<div class="modal fade" id="modal-tambah-admin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   ...
   <div class="modal-body">
     <form action="aksi_insert.php?tambah=data_admin" method="post">
      <div class="form-group">
        <label for="kode">Kode admin</label>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary" name="tambah_admin" id="tombol-tambah-admin">Tambahkan</button>
