          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="p-5">
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="input-group">
                    <input type="password" class="form-control" minlength="5" id="password2" name="password2" placeholder="Konfirm Password" required>
                    <div class="input-group-append">
                      <div class="input-group-text">
                        <span class="fas fa-lock"></span>
                      </div>
          ...
          success: function(hasil){
            if(hasil.insert == true){
              Swal.fire({
                icon: 'success',
                title: 'Berhasil...',
                text: 'Selamat Data Berhasil Di masukan, Silakan Login',
              })
              setTimeout(function(){
                document.location.href='index.php?pesan=Data Berhasil Di masukan, Silakan Login';
              },1000);
             ...
             Swal.fire({
              icon: 'warning',
              title: 'Oops...',
              text: 'Username Sudah Anda Yang Memakai!',
            })
