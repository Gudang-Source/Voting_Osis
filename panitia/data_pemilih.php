      ...
      $.ajax({
        ...
        success: function(hasil){
          ...
          $('.penampung-edit-pemilih').html(`
            ...
            <input  required="" type="text" id="jenis_kelamin" name="jenis_kelamin" class="form-control" value="${hasil.jenis_kelamin}">
            </div>
            <div class="alert alert-info">Jika Password Mau Di ganti Silakan isi from input password / jiak tidak tidak usah di isi</div>
            <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
   ...
   <div class="modal-body">
     <form action="aksi_insert.php?tambah=data_pemilih" method="post">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary" name="tambah_pemilih" id="tombol-tambah-pemilih">Tambahkan</button>
